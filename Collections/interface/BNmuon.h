...
struct BNmuon : BNlepton{
  ...
  int IDGMPTight,tkNumValidHits,tkCharge,samNumValidHits,samCharge,comNumValidHits,comCharge,isPFMuon,isGoodMuon_1StationTight,isGlobalMuon,isTrackerMuon,isStandAloneMuon,isGlobalMuonPromptTight,numberOfValidMuonHits,numberOfValidTrackerHits,numberOfLayersWithMeasurement,pixelLayersWithMeasurement,numberOfMatches,numberOfValidTrackerHitsInnerTrack,numberOfValidPixelHits,numberOfMatchedStations,time_ndof,innerTrackPt, innerTrackPtError;
