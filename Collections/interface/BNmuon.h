...
struct BNmuon : BNlepton {
  explicit BNmuon(double v, int c) : BNlepton(v, c, 0, 1),
    trackVetoIsoDR03(v), ecalVetoIsoDR03(v), hcalVetoIsoDR03(v),
    caloVetoIsoDR03(v), trackIsoDR05(v), ecalIsoDR05(v), hcalIsoDR05(v),
    caloIsoDR05(v), trackVetoIsoDR05(v), ecalVetoIsoDR05(v),
    hcalVetoIsoDR05(v), caloVetoIsoDR05(v), hcalE(v), ecalE(v),
    samNormChi2(v), samPT(v), samEta(v), samPhi(v), samDZ(v), samDZerr(v),
    samD0(v), samD0bs(v), samD0err(v), comNormChi2(v), comPT(v), comEta(v),
    comPhi(v), comDZ(v), comDZerr(v), comD0(v), comD0bs(v), comD0err(v),
    normalizedChi2(v), dVzPVz(v), dB(v), ptErr(v), innerTrackPt(v),
    innerTrackPtError(v), innerTrackNormChi2(v),
    pfIsoR03SumChargedHadronPt(v), pfIsoR03SumNeutralHadronEt(v),
    pfIsoR03SumPhotonEt(v), pfIsoR03SumPUPt(v),
    pfIsoR04SumChargedHadronPt(v), pfIsoR04SumNeutralHadronEt(v),
    pfIsoR04SumPhotonEt(v), pfIsoR04SumPUPt(v), timeAtIpInOut(v),
  ...
  BNmuon(): BNlepton(0, 1),
    ...
    caloVetoIsoDR03(-99), trackIsoDR05(-99), ecalIsoDR05(-99),
    hcalIsoDR05(-99), caloIsoDR05(-99), trackVetoIsoDR05(-99),
    ecalVetoIsoDR05(-99), hcalVetoIsoDR05(-99), caloVetoIsoDR05(-99),
    hcalE(-99), ecalE(-99), samNormChi2(-99), samPT(-99), samEta(-99),
    samPhi(-99), samDZ(-99), samDZerr(-99), samD0(-99), samD0bs(-99),
    samD0err(-99), comNormChi2(-99), comPT(-99), comEta(-99), comPhi(-99),
    comDZ(-99), comDZerr(-99), comD0(-99), comD0bs(-99), comD0err(-99),
    normalizedChi2(-99), dVzPVz(-99), dB(-99), ptErr(-99), innerTrackPt(-99),
    innerTrackPtError(-99), innerTrackNormChi2(-99), pfIsoR03SumChargedHadronPt(-99),
    pfIsoR03SumNeutralHadronEt(-99), pfIsoR03SumPhotonEt(-99),
    pfIsoR03SumPUPt(-99), pfIsoR04SumChargedHadronPt(-99),
    pfIsoR04SumNeutralHadronEt(-99), pfIsoR04SumPhotonEt(-99),
    ...
    numberOfValidMuonHits(-99), numberOfValidTrackerHits(-99),
  ...
  double trackVetoIsoDR05, ecalVetoIsoDR05, hcalVetoIsoDR05, caloVetoIsoDR05;
  double hcalE, ecalE;
  double samNormChi2, samPT, samEta, samPhi, samDZ, samDZerr, samD0, samD0bs, samD0err;
  double comNormChi2, comPT, comEta, comPhi, comDZ, comDZerr, comD0, comD0bs, comD0err;
  ...
  double timeAtIpInOut, timeAtIpInOutErr, timeAtIpOutIn, timeAtIpOutInErr;
  double ecal_time, hcal_time, ecal_timeError, hcal_timeError;
