...
namespace bean {
    struct Lepton : PhysicsObject {
        explicit Lepton(double v, int c, int e=0, int m=0) :
            ...
            genMotherEta(v), vx(v), vy(v), vz(v), tkNormChi2(v), tkPT(v), tkEta(v),
            tkPhi(v), tkDZ(v), tkDZerr(v), tkD0(v), tkD0bs(v), tkD0err(v),
            correctedD0(v), correctedD0Vertex(v), correctedDZ(v), particleIso(v),
            chargedHadronIso(v), neutralHadronIso(v), photonIso(v),
            puChargedHadronIso(v), chargedHadronIsoDR03(v),
        ...
        Lepton(int e=0, int m=0) :
            ...
            genMotherEta(-99), vx(-99), vy(-99), vz(-99), tkNormChi2(-99),
            tkPT(-99), tkEta(-99), tkPhi(-99), tkDZ(-99), tkDZerr(-99), tkD0(-99),
            tkD0bs(-99), tkD0err(-99), correctedD0(-99), correctedD0Vertex(-99),
            correctedDZ(-99), particleIso(-99), chargedHadronIso(-99),
            neutralHadronIso(-99), photonIso(-99), puChargedHadronIso(-99),
            chargedHadronIsoDR03(-99), neutralHadronIsoDR03(-99),
        ...
        double vx, vy, vz;
        double tkNormChi2, tkPT, tkEta, tkPhi, tkDZ, tkDZerr, tkD0, tkD0bs, tkD0err;
        double correctedD0, correctedD0Vertex, correctedDZ;
        double particleIso, chargedHadronIso, neutralHadronIso, photonIso, puChargedHadronIso;
        double chargedHadronIsoDR03, neutralHadronIsoDR03, photonIsoDR03, puChargedHadronIsoDR03;
