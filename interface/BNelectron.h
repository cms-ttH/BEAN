...
struct BNelectron : BNlepton {
	...
	int classification, genGrandMother11Id, numClusters, tkNumValidHits, tkCharge, gsfCharge, isEB, isEE, isGap, isEBEEGap, isEBGap, isEEGap, isEcalDriven, isTrackerDriven, numberOfLostHits, numberOfExpectedInnerHits, numberOfValidPixelHits, numberOfValidPixelBarrelHits, numberOfValidPixelEndcapHits, isHEEP, isHEEPnoEt, seedRecoFlag, eidRobustHighEnergy, eidRobustLoose, eidRobustTight, eidLoose, eidTight, eidVeryLooseMC, eidLooseMC, eidMediumMC, eidTightMC, eidSuperTightMC, eidHyperTight1MC, eidHyperTight2MC, eidHyperTight3MC, eidHyperTight4MC, passConvVeto;
